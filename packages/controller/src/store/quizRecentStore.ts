/**
 * Recently-used Kviz packs — per-device localStorage list of pack ids,
 * most-recent first. Recorded when a Kviz game starts and surfaced as the
 * "🕘 Nedavno korišćeno" strip in the picker. Mirrors the host helper (the
 * controller is a separate package); same `igra-quiz-recent` key.
 */
