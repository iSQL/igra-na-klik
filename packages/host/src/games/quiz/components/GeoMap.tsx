...
interface GeoMapProps {
  ...
  maxWidthCss?: string;
  /**
   * Custom question map image (`mapImageUrl`). When set, it replaces the
   * bundled Serbia map; the aspect ratio is measured from the loaded image
   * so pin percentages keep lining up.
   */
  mapImageUrl?: string;
}

/**
 * Map of Serbia (or a question's custom map) with overlaid pins. Used by the
 * TV on geo-question results (everyone's pin + the truth).
 */
