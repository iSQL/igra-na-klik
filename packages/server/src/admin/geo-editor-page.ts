...
#map-wrap{position:relative;width:100%;aspect-ratio:1901/2386;background:#E6DCD2;border-radius:13px;overflow:hidden;touch-action:none;cursor:crosshair;user-select:none}
