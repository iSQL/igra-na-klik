...
export const STRINGS: Record<Language, Record<string, string>> = {
  sr: {
    ...
    'quizConfig.search': 'Pretraži packove…',
    'quizConfig.recent': 'Nedavno korišćeno',
    'quizConfig.noResults': 'Nema packova za „{q}"',
    'quizConfig.selectedSummary': '{packs} packa · {questions} pitanja',
    'quizConfig.clear': 'Očisti',
    ...
    'quizType.uljez': 'Uljez',
    'quizType.dopuna': 'Završi citat',
    'quizType.piksel': 'Piksel',
    'quizType.anagram': 'Anagram',
    'quizType.redosled': 'Redosled',
    'quizType.domino': 'Domino',
    'quizType.matrica': 'Matrica',
    ...
    'config.hotPotatoMode.kviz': 'Kviz',
    'config.hotPotatoAnswerSeconds': 'Vreme za odgovor (sekunde)',
    ...
    'config.hotPotatoModeHint.kviz': 'Pitanje iz kviz packova — 5s za odgovor. Tačno = biraš kome ide sledeće, netačno = ispadaš!',
    // --- draw-guess ------------------------------------------------------
    ...
    'game.osvajanje.rule1':
      'Dva ili tri igrača. Svako bira svoj zamak, pa se kroz pitanja grabi slobodna zemlja.',
    ...
    'game.osvajanje.rule3':
      'Zamak ima tri zida. Ko ih sve sruši, uzima zamak i svu zemlju branioca — a branilac ispada. Igra traje dok ne ostane jedan.',
  ...
  en: {
    ...
    'quizConfig.search': 'Search packs…',
    'quizConfig.recent': 'Recently used',
    'quizConfig.noResults': 'No packs for "{q}"',
    'quizConfig.selectedSummary': '{packs} packs · {questions} questions',
    'quizConfig.clear': 'Clear',
    ...
    'quizType.emoji': 'Emoji',
    'quizType.uljez': 'Odd one out',
    'quizType.dopuna': 'Finish the quote',
    'quizType.piksel': 'Pixelated',
    'quizType.anagram': 'Anagram',
    'quizType.redosled': 'Ordering',
    'quizType.domino': 'Domino',
    'quizType.matrica': 'Matrix',
    ...
    'config.hotPotatoMode.kviz': 'Quiz',
    'config.hotPotatoAnswerSeconds': 'Time to answer (seconds)',
    ...
    'config.hotPotatoModeHint.kviz': 'A quiz question from the selected packs — 5s to answer. Correct = pick who gets the next one, wrong = you are out!',
    // --- draw-guess ------------------------------------------------------
    ...
    'game.osvajanje.description':
      'Raise a castle, spread across the map through questions and attack your neighbours. The game runs until only one castle is left standing!',
    ...
    'game.osvajanje.rule1':
      'Two or three players. Everyone picks a castle, then free land is grabbed by answering questions.',
    'game.osvajanje.rule2':
    ...
    'game.osvajanje.rule3':
      'A castle has three walls. Break them all and you take the castle and every territory its owner held — and they are out. Play runs until one is left.',
